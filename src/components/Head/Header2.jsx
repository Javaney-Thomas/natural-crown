...
import { Offcanvas, Button, Form, Nav } from 'react-bootstrap';
import { Link as ScrollLink } from 'react-scroll';
import { Link } from 'react-router-dom';
import { useStateValue } from '../../StateProvider';
import { product } from '../../product'; // Import the shared products data
...
// import { Link } from 'react-router-dom';
// import { useStateValue } from '../../StateProvider';
// import { product } from '../../product';  // Imported products
...
//               {searchResults.map((product) => (
//                 <div key={product.id} className="search-result-item">
//                   <img src={require(`${product.image}`).default} alt={product.name} className="search-result-image" />
//                   <div>
//                     <h5>{product.name}</h5>
//                     <p>${product.price}</p>
//                     <Button variant="primary" onClick={() => addToCart(product)}>Add to Cart</Button>
...
// import { Link } from 'react-router-dom';
// import { useStateValue } from '../../StateProvider';
// import { products } from '../../products'; // Import the shared products data
